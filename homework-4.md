...
В качестве аналогичной точки входи используем класс `Parameter`.

Используемся https://github.com/codewhitesec/ColdFusionPwn

и переопределим конструктор гаджета:
...
public class Parameter implements Externalizable {
    ...
    public Parameter(Object payload){
